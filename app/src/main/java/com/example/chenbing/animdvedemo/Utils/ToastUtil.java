...
import com.example.chenbing.animdvedemo.IceApplication;
...
public class ToastUtil extends Toast {
  ...
  public static void showLongToast(CharSequence text) {
    if (toast == null) {
      toast = ToastUtil.makeText(IceApplication.getAppContext(), text, Toast.LENGTH_LONG);
    } else {
      toast.setText(text);
    }
    toast.show();
  ...
  public static void showLongToast(int textId) {
    if (toast == null) {
      toast = ToastUtil.makeText(IceApplication.getAppContext(), textId, Toast.LENGTH_LONG);
    } else {
  ...
  public static void showShortToast(CharSequence text) {
    if (toast == null) {
      toast = ToastUtil.makeText(IceApplication.getAppContext(), text, Toast.LENGTH_SHORT);
    } else {
      toast.setText(text);
    }
    toast.show();
  ...
  public static void showShortToast(int textId) {
    if (toast == null) {
      toast = ToastUtil.makeText(IceApplication.getAppContext(), textId, Toast.LENGTH_SHORT);
    } else {
      toast.setText(textId);
    }
    toast.show();
